...
if (isset($_POST['update'])) {
  ...
  if ($jumlah >= $qtyskrg) {
    ...
    $updatedata1 = mysqli_query($conn, "update sbrg_masuk set jumlah='$jumlah' where id='$id'");
    ...
    $updatedata = mysqli_query($conn, "update sbrg_masuk set jumlah='$jumlah' where id='$id'");
...
<head>
  ...
  <title>Barang Masuk | Cipta Selaras Funiture</title>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="data-tables datatable-dark">
                  <div class="table-responsive">
                    <table id="dataTable3" class="table table-hover">
                      ...
                      <tbody>
                        ...
                        $brg = mysqli_query($conn, "SELECT sbrg_masuk.id, sbrg_masuk.idx, sbrg_masuk.id_supplier, sbrg_masuk.tgl, sbrg_masuk.jumlah, sstock_brg.idx, sstock_brg.nama, sstock_brg.jenis, sstock_brg.merk, sstock_brg.ukuran, ssuplier_brg.id_supplier, ssuplier_brg.nama_supplier FROM sbrg_masuk JOIN sstock_brg ON sbrg_masuk.idx = sstock_brg.idx JOIN ssuplier_brg ON sbrg_masuk.id_supplier = ssuplier_brg.id_supplier ORDER BY sbrg_masuk.id DESC");
                        $no = 1;
                              ...
                              <div class="modal-content">
                                <form method="post">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <input type="text" id="jumlah" name="jumlah" class="form-control" value="<?php echo $b['jumlah'] ?>" autofocus>
                  ...
                  <a href="exportbrgmsk.php" target="_blank" class="btn btn-info mt-4">Export Data</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-body">
          <form action="barang_masuk_act.php" method="post">
            ...
            <div class="form-group">
              ...
              <select name="barang" class="custom-select form-control" style="height: 3.3em;" required>
